...
from legacy_code_assistant.rag_integration.rag_prompts import (
    modifyPrompt, analyzePrompt, addPrompt, testPrompt, vulnerabilityPrompt, refactorPrompt)
...
class RagManager:
    def __init__(self, filepath, index_name, credentials_filepath):
        ...
        self.kbb_docs = KnowledgeBaseBuilder(
    ...
    def refactor_code(self, user_input, context=None):
        return self._run_chain(refactorPrompt, user_input, context=context)
